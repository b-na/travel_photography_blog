...
export default function OverlayPage({link, alt, location, func, handleSubmit}) {
    ...
    return (
        <div id='overlay-page-bg' onClick={(e) => {e.target.id === 'overlay-page-bg' && func()}}>
            <div id='overlay-page'>
